...
// upload with ```bash
// gcloud alpha functions deploy autotag --stage-bucket dev-art-functions --trigger-bucket dev-art-uploads
...
exports.autotag = function autotag (context,data) {
    ...
    recordInDatabase = (results) => {
        ...
        let thisUID  = path[1];
        let artUID   = path[3];
        let dataPath = `/onboarders/${thisUID}/artworks/${artUID}`;
    ...
    const FBDatabaseUrl = "https://project-7614141605200030275.firebaseio.com";
