module.exports = {
    'Test Login: No Email Error' : function (browser) {
        browser
            ...
            .waitForElementVisible('.login-error span', 4000)
            .assert.containsText('.login-error span', 'Please enter an email address.')
            .end();
    },
    'Test Login: Invalid Email Error' : function (browser) {
        browser
            ...
            .click('button.login-button')
            .waitForElementVisible('.login-error span', 3000)
            .assert.containsText('.login-error span', 'The email address you supplied is invalid.')
            .end();
    },
    'Test Login: No Password Error' : function (browser) {
        browser
            ...
            .click('button.login-button')
            .waitForElementVisible('.login-error span', 1000)
            .assert.containsText('.login-error span', 'Please enter your password.')
            .end();
    },
    'Test Login: User Doesnt Exist Error' : function (browser) {
        browser
            ...
            .setValue('.hidden-login input[type=password]', 'password')
            .click('button.login-button')
            .waitForElementVisible('.registration-error span', 5000)
            .assert.containsText('.registration-error span', 'There is no user record corresponding to this identifier. The user may have been deleted.')
            .end();
    },
    'Test Login: Invalid Email/Password Error' : function (browser) {
        browser
            ...
            .click('button.login-button')
            .waitForElementVisible('.registration-error span', 5000)
            .assert.containsText('.registration-error span', 'The password is invalid or the user does not have a password.')
            .end();
    },
