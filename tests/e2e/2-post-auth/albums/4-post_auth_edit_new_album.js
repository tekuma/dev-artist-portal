module.exports = {
    'Test Album: Edit New Album (Edit Album Name)' : function (browser) {
        // Add artwork into New Album, and press edit button
        // Edit album name and save
        ...
        browser
            ...
            .waitForElementVisible('li.album.black:nth-child(2) img.album-tool.edit', 3000)
            .click('li.album.black:nth-child(2) div.album-tools img.album-tool.edit')
            .waitForElementVisible('div.edit-album-content', 3000)
            .clearValue('div.edit-album-content input[type=text]#album-title')
            .setValue('div.edit-album-content input[type=text]#album-title', 'Edited Album Name')
            ...
            .assert.value('div.edit-artwork-content select.edit-artwork-select', 'Edited Album Name')
            .click('button.edit-artwork-no')
            .pause(1000)
            // Then check Album
            .waitForElementVisible('li.album.black:nth-child(2) img.album-tool.edit', 3000)
            .click('li.album.black:nth-child(2) img.album-tool.edit')
            .waitForElementVisible('div.edit-album-content', 3000)
            .assert.value('input[type=text]#album-title', 'Edited Album Name')
    ...
    'Test Album: Edit New Album (Edit Artist)' : function (browser) {
        // Add artwork into New Album, and press edit button
    ...
    'Test Album: Edit New Album (Edit Year)' : function (browser) {
        // Add artwork into new album, and press edit button
    ...
    'Test Album: Edit New Album (Edit Tags - One Tag)' : function (browser) {
        // Add artwork into new album, and press edit button
    ...
    'Test Album: Edit New Album (Edit Tags - Two Tags)' : function (browser) {
        // Add artwork into new album, and press edit button
        // Edit album tags and save
        // Check if artwork and album have same tags
        browser
    ...
    'Test Album: Edit New Album (Edit Description)' : function (browser) {
        // Add artwork into new album, and press edit button
        // Edit album year and save
        // Check if artwork and album have new year
        browser
